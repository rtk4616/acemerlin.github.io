...
WelcomeState.prototype.enter = function(game) {
    ...
    game.sounds.init();
    game.sounds.loadSound('shoot', 'spaceinvaders/sounds/shoot.wav');
    game.sounds.loadSound('bang', 'spaceinvaders/sounds/bang.wav');
    game.sounds.loadSound('explosion', 'spaceinvaders/sounds/explosion.wav');
};
